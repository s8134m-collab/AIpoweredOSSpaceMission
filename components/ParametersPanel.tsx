...
export const ParametersPanel: React.FC<ParametersPanelProps> = ({
  ...
  return (
    <div className="p-6 bg-transparent h-full flex flex-col items-start pt-8">
      ...
      <div className="w-full max-w-md mb-4">
        <div className="llm-row items-center">
          ...
          <input
            ...
            className="h-5 w-5 text-blue-500 bg-gray-700 border-gray-500 rounded focus:ring-blue-500 cursor-pointer"
      ...
      <div className="mt-6 w-full max-w-md flex justify-start gap-3">
        ...
        <button
          onClick={handleClose}
          className="llm-button bg-gray-700 hover:bg-gray-600 active:bg-gray-500"
